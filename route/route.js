...
const { adminRegister, adminSignIn, updateAdmin, getUsers, deleteUser, superAdminRegister, superAdminSignin, listUsers, listAdmins, listSuperAdmins, adminSignin } = require('../controller/adminController');
